...
-- Comentario que indica que a continuación se definirá la estructura de la tabla proveedor
...
CREATE TABLE `proveedor` (
  ...
  -- Estado del proveedor (1 = activo, 0 = inactivo)
...
-- Sección para insertar los datos de la tabla proveedor
